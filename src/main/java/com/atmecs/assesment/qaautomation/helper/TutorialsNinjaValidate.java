...
public class TutorialsNinjaValidate {
	...
	public void TutorialsNinjaHelper(WebDriver driver) {
		this.driver = driver;
	}
		public void performAction(WebDriver driver, String expectedData, String validationMessage) throws Exception {
			...
			actualproduct = page.getText(read.readPropertiesFile(validationMessage, ConstantPaths.tutorialsninja));
